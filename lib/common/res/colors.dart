...
class Colours {
  ...
  static const Color selected_item_color = Color(0xCCFFA200);
  static const Color unselected_item_color = Color(0xff666666);

  static const Color bg_gray_ = Color(0xFFFAFAFA);
  static const Color dark_bg_gray_ = Color(0xFF242526);

  static const Color content_gray_bg = Color(0xFFF4F4F4);

  static const Color nav_action_color = Color(0xFFFF9600);
